...
const ModalRunningLoans = () => {
    return (
        <div className="modal fade" id="running" tabIndex={-1} role="dialog" aria-labelledby="runningmodal" aria-hidden="true">
            <div className="modal-dialog modal-lg" role="document">
                <div className="modal-content position-relative">
                    ...
                    <div className="modal-header" style={{ background: '#E31C1C' }}>
                        <h5 className="modal-title r-14 text-white" id="exampleModalLongTitle">Running Loans</h5>
...
export default ModalRunningLoans
