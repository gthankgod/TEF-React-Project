...
const ModalLoanSchedule = () => {
    return (
        <div className="modal fade" id="schedule" tabIndex={-1} role="dialog" aria-labelledby="schedulemodal" aria-hidden="true">
            <div className="modal-dialog modal-lg" role="document">
                <div className="modal-content position-relative">
                    ...
                    <div className="modal-header" style={{ background: '#E31C1C' }}>
                        ...
                        <span className="ml-auto r-12 text-white">Your current Take Home Net Amount is N4,256,144.07</span>
                    </div>
                    <div className="modal-body">
                        <div className="row">
                            ...
                            <div className="col-lg-6 text-right">
                                ...
                                <button className="btn btn-green" data-toggle="modal" data-target="#request">
                                    Submit Request
                    </button>
                            </div>
                        </div>
...
export default ModalLoanSchedule
